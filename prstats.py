...
for i in data:
    if i['user']['login'] == user or not user:
        # get date of pull creation
        crday = datetime.datetime. \
            strptime(i['created_at'][0:10], '%Y-%m-%d')
        ...
        if option == 'day':
            print('Pull #{}. User:{}. Number of days: {}'.
                  format(i['number'], i['user']['login'], daydiff))
        # print week
        elif option == 'weeks':
            print('Pull #{}. User:{}. Day of the week opened: {}'.
                  format(i['number'], i['user']['login'], weeknum))
        # print every option
        elif not option:
            print('Pull #{}. User: {}. Number of days: {}. '
                  ...
                  format(i['number'],
                         i['user']['login'],
                         daydiff, weeknum, i['state'], i['id'], i['title']))
        # print other options
        elif option == "state" or option == "id" or option == "title":
            print('Pull #{}. User: {}. {}: {}.'.
                  format(i['number'],
                         i['user']['login'], option, i[option]))
        else:
